...
export default function TransferenciasPropias() {
  ...
  const total = parsedAmount + tax + LBTR_FEE;
  ...
  const validate = () => {
    ...
    if (!destino) newErrors.destino = 'Selecciona una cuenta destino';
    if (origen && destino && origen === destino)
      newErrors.destino = 'La cuenta destino debe ser diferente a la origen';
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          />
          <p style={{ color: colors.textSecondary }}>Cargando cuentas...</p>
        </div>
      </div>
    );
  }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{
                    borderColor: errors.monto ? colors.error : colors.border,
                  }}
                />
              </div>
              {errors.monto && (
        ...
        >
          ...
          >
            ...
            <div className="py-4 space-y-3">
              ...
              <div className="flex justify-between">
                <span style={{ color: colors.textSecondary }}>Cargo por LBTR</span>
                <span className="font-semibold" style={{ color: colors.textPrimary }}>
                  {formatCurrency(LBTR_FEE)}
                </span>
              </div>
            </div>
